var map;
      ...
      function initMap() {
        ...
        // These are the list of places that will be shown to the user.
        var locations = [
        ...
        document.getElementById('show-touristspots').addEventListener('click', showListings);

        document.getElementById('hide-touristspots').addEventListener('click', function() {
          hideMarkers(markers);
        });
      ...
      function zoomToArea() {
        ...
        if (address == '') {
          ...
          geocoder.geocode(
            { address: address,
              componentRestrictions: {locality: 'Salt Lake City, Utah'}
